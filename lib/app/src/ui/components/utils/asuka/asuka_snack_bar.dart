...
class AsukaSnackbar extends SnackBar {
  ...
  factory AsukaSnackbar.warning(String content, {Key? key}) =>
      AsukaSnackbar._(key, content, const Color(0xFFE6CA72),
          icon: Icons.warning);
  ...
  factory AsukaSnackbar.alert(String content, {Key? key}) =>
      AsukaSnackbar._(key, content, const Color(0xffFA5456),
          icon: Icons.report);
  ...
  factory AsukaSnackbar.info(
    ...
    SnackBarAction? snackBarAction,
      ...
      AsukaSnackbar._(key, content, const Color(0xff3196DA),
  ...
  factory AsukaSnackbar.success(
    ...
    SnackBarAction? snackBarAction,
      ...
      AsukaSnackbar._(key, content, const Color(0xFF80AD49),
  ...
  factory AsukaSnackbar.message(String content, {Key? key}) =>
      AsukaSnackbar._(key, content, const Color(0xff484848));
